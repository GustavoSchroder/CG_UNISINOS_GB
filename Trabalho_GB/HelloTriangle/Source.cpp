...
int main()
{
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		glm::mat4 model;
		//model = glm::rotate(model, glm::radians(20.0f * (GLfloat)rotateWithp), glm::vec3(0.0f, 1.0f, 0.0f));
		//model = glm::translate(model, position);
		//model = glm::scale(model, glm::vec3(3.0f, 3.0f, 3.0f));
		glm::mat4 view;
		view = camera.GetViewMatrix();
		glm::mat4 projection = glm::perspective(camera.Zoom, (GLfloat)WIDTH / (GLfloat)HEIGHT, 0.1f, 40.0f);
